!(function (e) {
  ...
  'use strict';r.r(t);t.default = { prefixed: 'seal', componentProgress: ''.concat('seal', '-progress'), componentSteps: ''.concat('seal', '-stepper'), componentPicker: ''.concat('seal', '-picker'), componentGesture: ''.concat('seal', '-gesture') };
}]));
