!(function (e) {
  ...
  Component({ externalClasses: ['ext-class'], options: { addGlobalClass: !0 }, properties: { type: { type: String, value: 'circular' }, size: { type: Number, value: 20 }, color: { type: String, value: '' }, textSize: { type: Number, value: '' }, vertical: { type: Boolean, value: !1 } }, data: { bladeNum: 12 } });
} }));
